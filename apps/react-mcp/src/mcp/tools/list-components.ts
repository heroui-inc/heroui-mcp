...
export const listComponentsTool: Tool = {
  ...
  description: `List all available components in HeroUI v3 (Alpha) - v2 components NOT supported.
⚠️ VERSION INFO: This returns v3 ALPHA components only - NOT v2 components.
...
Note: v3 is ALPHA - component list may change before stable release.`,
